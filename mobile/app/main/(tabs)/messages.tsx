...
const mockConversations: Conversation[] = [
  {
    ...
    lastMessage: {
      id: 'm1',
      senderId: 't1',
      text: 'I can start the job next Monday if that works for you?',
      timestamp: '2024-05-20T14:30:00Z',
      status: 'READ',
      type: 'TEXT',
    },
    unreadCount: 2,
    jobTitle: 'Driveway Resurfacing',
  },
  {
    id: 'c2',
    participant: {
    ...
    lastMessage: {
      id: 'm2',
      senderId: 'me',
      text: 'Thanks for the quote! I will get back to you soon.',
  ...
  },
  {
    ...
    lastMessage: {
      id: 'm3',
      senderId: 't3',
      text: 'Please find attached the updated quote with materials included.',
...
const mockMessages: Message[] = [
  {
    id: '1',
    senderId: 't1',
    text: 'Hi! Thanks for considering Premier Paving for your driveway project.',
  ...
  },
  {
    id: '2',
    senderId: 'me',
    text: 'Hi John, thanks for getting back to me so quickly!',
  ...
  },
  {
    id: '3',
    senderId: 'me',
    text: 'I had a few questions about the quote you sent.',
  ...
  },
  {
    id: '4',
    senderId: 't1',
    text: 'Of course! Feel free to ask anything. I am here to help.',
  ...
  },
  {
    id: '5',
    senderId: 'me',
    text: 'Does the quote include removing the old concrete surface?',
  ...
  },
  {
    id: '6',
    senderId: 't1',
    text: 'Yes, absolutely! The £4,200 quote includes:\n\n✓ Removal of existing concrete\n✓ Base preparation and compaction\n✓ High-quality block paving materials\n✓ Professional installation\n✓ Waste disposal\n✓ 10-year guarantee',
